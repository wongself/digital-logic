...
HD_PWD='D:/Experiment_01 Flowing Water Light/Flowing Water Light/Flowing Water Light.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Flowing_Water_Light.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Flowing_Water_Light.tcl -notrace
