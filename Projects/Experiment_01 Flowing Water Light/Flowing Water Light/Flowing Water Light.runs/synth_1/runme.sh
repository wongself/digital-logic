...
HD_PWD='D:/Experiment_01 Flowing Water Light/Flowing Water Light/Flowing Water Light.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Flowing_Water_Light.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Flowing_Water_Light.tcl
